...
// // import 'package:wms/customer/storage/cs_kc_sub_page.dart';
// import 'package:wms/models/market/market_wares_model.dart';

// import 'kc_tabbarview_logic.dart';
// import 'kc_tabbarview_state.dart';
// import 'package:wms/customer/storage/kucun/common/kc_select_widget/kc_select_widget_logic.dart';
// import 'package:wms/customer/storage/kucun/common/kc_select_widget/kc_select_widget_state.dart';
...
//       this.onChangedAllCheckboxChild});
...
//                   print("parentState.spuSelectAllCheckbox = " +
//                       parentState.spuSelectAllCheckbox.toString());
//                   var check = true;
//                   parentState.spuDataList.forEach((element) {
//                     print("element.spuId = " + element.spuId.toString());
//                     print(parentState.spuSelectAllCheckbox[element.spuId]
//                         .toString());
//                     if (parentState.spuSelectAllCheckbox[element.spuId] ==
//                         null) {
//                       check = false;
//                       parentLogic.update();
//                       return;
