...
class CSYiChuKuDetailPage extends StatefulWidget {
  final int wmsOutStoreId;

  const CSYiChuKuDetailPage({Key key, this.wmsOutStoreId}) : super(key: key);

  @override
  _CSYiChuKuDetailPageState createState() => _CSYiChuKuDetailPageState();
}

class _CSYiChuKuDetailPageState extends State<CSYiChuKuDetailPage> {
  ...
  Future<bool> requestData() async {
    ...
    var data = await HttpServices().csAlreadyDetail(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              //   callback: () => Get.to(
              //     () => ENLogisticsPage(
              //       dataCode: dataModel.expressNumber,
              //     ),
              //   ),
              // ),
              GestureDetector(
