...
class CSDaiShangJiaList extends StatefulWidget {
  final int depotId;
  final String yearMonth;
  const CSDaiShangJiaList({Key key, this.depotId, this.yearMonth = ''})
      : super(key: key);

  @override
  CSDaiShangJiaListState createState() => CSDaiShangJiaListState();
}

class CSDaiShangJiaListState extends State<CSDaiShangJiaList> {
  int depotId; //哪个仓库
