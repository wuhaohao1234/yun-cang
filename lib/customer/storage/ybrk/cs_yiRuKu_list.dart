...
class CSYiRuKuList extends StatefulWidget {
  final int depotId;
  final String yearMonth;
  const CSYiRuKuList({Key key, this.depotId, this.yearMonth = ''})
      : super(key: key);

  @override
  CSYiRuKuListState createState() => CSYiRuKuListState();
}

class CSYiRuKuListState extends State<CSYiRuKuList> {
